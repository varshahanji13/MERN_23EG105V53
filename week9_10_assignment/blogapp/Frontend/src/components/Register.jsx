  ...
  formData.append("profileImageUrl", profileImageUrl[0]);
    ...
    try {
      if (role === "user") {
        ...
        let resObj = await axios.post("https://mern-23eg105v53.onrender.com/user-api/users", formData);
      ...
      if (role === "author") {
        ...
        //make API req to user-api
        let resObj = await axios.post("https://mern-23eg105v53.onrender.com/author-api/users", formData);
